...
<div class=" row w-50">
    ...
    <b-form-radio style="width:max-content" @change="setRightAnswer()" :name="'Questions'.concat(question.id)" :value="choices.id"
    ...
    <button class="button_delete rounded-circle  btn-danger" v-on:click="deleteChoice(choices.id,question.choices)">X</button>
</div>
...
export default {
    ...
    data() {
        return {
            ...
            position: [],
            rightAnswer: false,
            selected: document.getElementsByName('some-radios'),
        }
    },
