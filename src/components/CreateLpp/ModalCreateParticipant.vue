    ...
    <slot name="body">
        ...
        <div class="container" v-else>
            <div class="row" style="margin-top:2%">
                <p style="margin:0">Табельный номер:</p>
                <b-form-input 
        ...
        <div style="margin-top:2%" class="row">
            ...
            <div class="col-lg-3 col-6 col-sm-4">
                <b-button class="btn" @click="create">
...
export default {
    ...
    methods:{
        ...
        async create(){
            ...
            await this.$store.dispatch('createLpp/createParticipant',{portrait:this.portrait,data:this.data})
            .then(async ()=>{
