...
<transition name="modal" style="display:block; width:100%">
    ...
    <slot name="body">
        ...
        <div style="text-align:left; margin-bottom:2%">
            <h1 style="font-size:25px;">Редактирование жюри</h1>
        </div>
        <div class="container">
        ...
        <div style="margin-top:10%" class="row">
            ...
            <div class="col-lg-3 col-6 col-sm-4">
                <b-button class="btn" @click="editJudge">
...
export default {
    ...
    beforeMount(){
        this.data=this.$store.getters['lpp/getJudgeById'](this.judgeId)
    },
    methods:{
        addPortraint(){
        ...
        async editJudge(){
            ...
            await this.$store.dispatch('createLpp/editJudge',{portrait:this.portrait,data:this.data})
            .then(()=>{
                this.$emit('close')
            })
            .catch(err=>{
